...
if(isset($_POST['form-insert']) and $_POST['form-insert'] == 'sent')
{
   ...
   $formDataFile = fopen("form-data.txt", 'w');

   fwrite($formDataFile, "E-mail: ".$_POST['email'] . "\n");
   fwrite($formDataFile, "Heslo: ".$_POST['password'] . "\n");
   fwrite($formDataFile, "Potvrzení hesla: ".$_POST['password2'] . "\n");
   fwrite($formDataFile, "Jméno: ".$_POST['name'] . "\n");
   fwrite($formDataFile, "Příjmení: ".$_POST['surname'] . "\n");
   fwrite($formDataFile, "Ulice: ".$_POST['street'] . "\n");
   fwrite($formDataFile, "Město: ".$_POST['city'] . "\n");
   fwrite($formDataFile, "PSČ: ".$_POST['zip'] . "\n");
   fwrite($formDataFile, "Kraj: ".$regions[$_POST['region']] . "\n");
   fwrite($formDataFile, "Pohlaví: ".($_POST['sex'] === "male" ? "muž" : "žena") . "\n");
   fwrite($formDataFile, "E-Poznámka: ".$_POST['note']);

   fclose($formDataFile);

   if(file_exists("form-data.txt")) {

       $formDataFile = fopen("form-data.txt", 'r');

       echo '<div class="alert alert-success" role="alert">' . "\n";

       while(!feof($formDataFile)) {
           echo '<p class="text-center">' . fgets($formDataFile) . '</p>' . "\n";
       }
/*
       echo '<div class="alert alert-success" role="alert">' . "\n";
