...
echo '<input type="hidden" name="form-insert" value="sent">'."\n";
  ...
  echo '<div class="form-group row">'."\n";
    ...
    echo '<div class="col-md-10">'."\n";
      echo '<input type="text" class="form-control" name="surname" id="surname">'."\n";
    echo '</div>'."\n";
  echo '</div>'."\n";

    echo '<div class="form-group row">'."\n";
    echo '<label for="street" class="col-md-2 col-form-label">Ulice a č.p.</label>'."\n";
    echo '<div class="col-md-10">'."\n";
    echo '<input type="text" class="form-control" name="street" id="street">'."\n";
    echo '</div>'."\n";
    echo '</div>'."\n";
    ...
    echo '<div class="col-md-10">'."\n";
    echo '<input type="number" class="form-control" name="zip" id="zip">'."\n";
    echo '</div>'."\n";
    echo '</div>'."\n";
    ...
    echo '<div class="col-md-10">'."\n";
    echo '<textarea class="form-control" name="note" id="note"></textarea>'."\n";
    echo '</div>'."\n";
    echo '</div>'."\n";
...
if(isset($_POST['form-insert']) and $_POST['form-insert'] == 'sent')
{
    ...
    echo '<p class="text-center">Email: '.$_POST['email'].'</p>'."\n";
    ...
    echo '<p class="text-center">Ulice a č.p.: '.$_POST['street'].'</p>'."\n";
    echo '<p class="text-center">Město: '.$_POST['city'].'</p>'."\n";
    echo '<p class="text-center">PSČ: '.$_POST['zip'].'</p>'."\n";
    echo '<p class="text-center">Kraj: '.$_POST['region'].'</p>'."\n";
    echo '<p class="text-center">Pohlaví: '.$_POST['sex'].'</p>'."\n";
