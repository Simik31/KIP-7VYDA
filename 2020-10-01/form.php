...
$regions = array();
$regions["praha"] = "Hlavní město praha";
$regions["stredocesky"] = "Středočeský";
$regions["liberecky"] = "Liberecký";
$regions["ustecky"] = "Ústecký";
$regions["karlovarsky"] = "karlovarský";
$regions["plzensky"] = "Plzeňský";
$regions["jihocesky"] = "jihočeský";
$regions["pardubicky"] = "Pardubický";
$regions["kralovehradecky"] = "Královéhradecký";
$regions["vysocina"] = "Vysočina";
$regions["jihomoravsky"] = "Jihomoravský";
$regions["olomoucky"] = "Olomoucký";
$regions["moravskoslezsky"] = "Moravskoslezský";
$regions["zlinsky"] = "Zlínský";
...
if(isset($_POST['form-insert']) and $_POST['form-insert'] == 'sent')
{
    ...
    if($_POST["sex"] === "male")  echo '<p class="text-center">Pohlaví: muž</p>'."\n";
    elseif($_POST["sex"] === "female")  echo '<p class="text-center">Pohlaví: žena</p>'."\n";
